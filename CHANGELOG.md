...
- Fix Make targets
- Update go version
- Migrate GitHub Pages to Actions-based deployment
- Migrate GitHub Pages to Actions-based deployment (#64)
...
- Add locksmith env vars to gateway
- Auto-derive jwks location and wire legacy labels env var
- Add locksmith env vars to gateway (#61)
- Add thanos for long-term metrics
- Extend config with solver, idle, locksmith and valkey settings
- Add HERE_APIKEY env from secret for HERE WiFi solver
- Add Helm chart for truvami-rmx application
- Add new grpc port
- Tune database pooling for PgBouncer transaction mode
- Add helm chart for pulse campaign execution service
- Add helm chart for pulse campaign execution service (#71)
...
- Honor pre-commit filenames in values-check & avoid set -e abort
- Honor pre-commit filenames in values-check & avoid set -e abort (#63)
- Add configurable Thanos sidecar resources
- Harden Thanos monitoring stack after 2026-07 prod outage
- Address review feedback on chart guardrails
