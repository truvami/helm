...
| stream.server.cors.allowedOrigins[1] | string | `"http://stream.truvami.com"` |  |
| stream.server.cors.allowedOrigins[2] | string | `"http://stream.test.truvami.com"` |  |
...
| volumeMounts[0].mountPath | string | `"/etc/truvami-stream"` |  |
| volumeMounts[0].name | string | `"config"` |  |
| volumeMounts[0].readOnly | bool | `true` |  |
| volumes[0].configMap.defaultMode | int | `420` |  |
| volumes[0].configMap.name | string | `"config-stream"` |  |
